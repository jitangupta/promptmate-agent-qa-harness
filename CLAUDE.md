# PromptMate Test Suite — Claude Context
...
|---|---|---|
| Claude | `https://claude.ai/new` | `claude-content.bundle.js` |
...
For each platform in this order: **claude.ai → chatgpt.com → chat.deepseek.com → kimi.com**:
- Navigate to the URL
- Open PromptMate
